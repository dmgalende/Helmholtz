...
% Mesh
filemesh = 'Farfield_expansions/centered_R2/mesh7_P4_20ppw.dcm';

% Savefile
savefile = 'KSFE_neum_R2_pid4_20ppw.mat';
...
wavenumber = pi/4;  %only affects if nwaves = -1
inc_angle = 0;
