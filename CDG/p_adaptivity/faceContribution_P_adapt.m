function [XX,XY,YX,YY] = faceContribution_P_adapt(face_1,face_2,...
    refEl_1,refEl_2,Xe1,Xe2,n,A,alpha_f,C11,C12,sigma_f,omega,...
    N1,N2,N1xi,N2xi,N1eta,N2eta)
...
xe2 = Xe2(:,1); ye2 = Xe2(:,2);
%inizialization
XX = zeros(nOfElementNodes_1);
XY = zeros(nOfElementNodes_1,nOfElementNodes_2);
YX = zeros(nOfElementNodes_2,nOfElementNodes_1);
YY = zeros(nOfElementNodes_2);
Con3_11 = zeros(nOfElementNodes_1,nOfFaceNodes_1);
Con3_12 = zeros(nOfElementNodes_1,nOfFaceNodes_2);
Con3_21 = zeros(nOfElementNodes_2,nOfFaceNodes_1);
Con3_22 = zeros(nOfElementNodes_2,nOfFaceNodes_2);
Con7_11 = zeros(nOfFaceNodes_1,nOfFaceNodes_1); 
Con7_12 = zeros(nOfFaceNodes_1,nOfFaceNodes_2);
Con7_22 = zeros(nOfFaceNodes_2,nOfFaceNodes_2);
for g = 1:ngauss
    ...
    Con7_22 = Con7_22 +  N2_g' * N2_g * C11 * dL;
...
Con6_21 = -C12 * Con4_21;
Con6_22 = -C12 * Con4_22;
Con7_21 = transpose(Con7_12);

% assembly
nodes = refEl_1.faceNodes(face_1,:);
nodes2 = refEl_2.faceNodes(face_2,:);
