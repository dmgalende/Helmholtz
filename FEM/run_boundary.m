...
for iboundary = 1:nOfBoundaries
    ...
    if data.staticCondensation
        ...
        elseif icond == 2
            ...
            if strcmpi(iname,'ext') %Ext boundary is a PML boundary by definition
                setOutput({'       Reflecting vector...'},handle)
                boundaryVectorSum = boundaryVectorSum +...
        ...
        elseif icond == 3
            ...
            boundaryMatrixSum = boundaryMatrixSum +...
                berkhoffNRBCMatrix(data.mesh.(nameNodal),...
                                   ...
                                   data.bottom.ccg,...
                                   iparam);
            setOutput({'       Non reflecting boundary vector...'},handle)
            boundaryVectorSum = boundaryVectorSum +...
                berkhoffNRBCVector(data.mesh.(nameNodal),...
                                         data.mesh.(inameCon),...
                                         data.mesh.referenceElement,...
                                         data.ip.value,...
                                         data.ip.gradientsIP.(iname),...
...
% Vector on the exterior boundary (boundary of the PML area with interface)
if data.staticCondensation
    
else
    boundaryVectorSum = -boundaryVectorSum +...
                berkhoffExteriorVector(data.mesh.(nameNodal),...
                                       data.mesh.extTb,...
                                       data.mesh.referenceElement,...
                                       data.ip.gradientsIP.extTb,...
                                       data.bottom.ccg,...
                                       data.PMLabsorptionValue,...
                                       omega);
end
