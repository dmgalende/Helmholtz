function C = berkhoffDampingMatrix_NEFEM...
    (X,TRobin,referenceElement,nurbs,trimmedInfo,k,ccg,NNZ_nefem)

%
%  C = berkhoffDampingMatrix_NEFEM...
%    (X,TRobin,referenceElement,nurbs,trimmedInfo,k,ccg)
%
